...
export interface PluginTodoTodo extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedBy: Attribute.Relation<"plugin::todo.todo", "oneToOne", "admin::user"> & Attribute.Private;
  };
}
...
export interface ApiRecipeRecipe extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ingredients: Attribute.DynamicZone<["ingredients.ignredient-category", "ingredients.ingredient"]>;
    images: Attribute.Media;
    tags: Attribute.Relation<"api::recipe.recipe", "manyToMany", "api::tag.tag">;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"api::recipe.recipe", "oneToOne", "admin::user"> & Attribute.Private;
    updatedBy: Attribute.Relation<"api::recipe.recipe", "oneToOne", "admin::user"> & Attribute.Private;
  };
}
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  attributes: {
    ...
    recipe: Attribute.Relation<"api::tag.tag", "manyToMany", "api::recipe.recipe">;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
